...
import 'package:flutter_basic_topics/reusable_widgets/small_widgets.dart';
...
class _HorizontalWeekCalendarState extends State<HorizontalWeekCalendar> {
  ...
  Widget build(BuildContext context) {
    ...
    double boxHeight = withOfScreen / 12;
              ...
              children: [
                Container(
                  ...
                  child: Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [
                      listMainTitle(title: "Ticket Id"),
                      const SizedBox(width: 30),
                      filterIcons(),
                      const SizedBox(width: 20),
                      listMainTitle(title: "Plant Name"),
                      const SizedBox(width: 30),
                      filterIcons(),
                      const SizedBox(width: 20),
                      listMainTitle(title: "PPOC Assigned"),
                      const SizedBox(width: 30),
                      filterIcons(),
                      const SizedBox(width: 20),
                      listMainTitle(title: "Contact"),
                      const SizedBox(width: 30),
                      filterIcons(),
                      const SizedBox(width: 20),
                      listMainTitle(title: "Issue Reported"),
                      const SizedBox(width: 30),
                      filterIcons(),
                      const SizedBox(width: 20),
                      listMainTitle(title: "District"),
                      const SizedBox(width: 30),
                      filterIcons(),
                      const SizedBox(width: 20),
                      listMainTitle(title: "Action"),
                      const SizedBox(width: 30),
                      filterIcons(),
                      const SizedBox(width: 30),
                      listMainTitle(title: "Status"),
                    ],
                  ),
                ),
                const Divider(
